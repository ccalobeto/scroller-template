<script>
	...
	onMount(() => {
		// live = true;
		live =
			window.location.hostname == 'www.ons.gov.uk' || window.location.hostname == 'cy.ons.gov.uk';
				...
				<div class="cookies-banner__wrapper wrapper">
					<div>
						<div class="cookies-banner__message font-size--18">
							...
							<p class="cookies-banner__body">
								We use this information to make the website work as well as possible and improve our
								services.
							</p>
						</div>
