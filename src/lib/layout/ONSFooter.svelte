...
<footer style:--text={colors.text} style:--background={colors.background} style:--muted={colors.muted} style:--pale={colors.pale}>
	<div class="col-wide" data-analytics="footer">
		...
		<div class="license">
			...
			<a
				...
				class="link"
				target="_blank"
				rel="noopener">Open Government Licence v3.0</a>, 
...
<style>
	footer {
		...
		font-size: 18px;
    color: var(--text, #222);
    background-color: var(--pale, #f0f0f0);
	}
	footer a.link {
	...
	footer hr {
		...
		margin-top: 36px;
		border: none;
		border-top: 1px solid var(--muted, #777);
	}
  footer svg > path {
    fill: var(--muted, #777);
  }
